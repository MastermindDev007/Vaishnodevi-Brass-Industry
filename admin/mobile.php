...
<body>
     ...
     <div class="mobile">
          <div class="form shadow-lg">
               <h3 class="tp-title-pre">Mobile</h3>
               <p class="tp-title">Add Mobile</p>
               <form action="insert_mobile.php" method="post">
                    <input type="text" name="name" class="form-control" placeholder="Enter Name">
                    <input type="number" name="mob" class="form-control" placeholder="Enter Mobile Number">
                    <input type="number" name="status" class="form-control" placeholder="Enter Status Number (1 or 0)">
                    <input type="submit" class="submit1 " name="add_mobile_number" value="ADD">
               </form>
          </div>
               ...
               <tbody>
                    ...
                    ?>
                         <tr>
                              ...
                              <td><a href="update_mobile.php?id=<?php echo $fld['id']?>" class="btn btn-success">Update</a></td>
                              <td><a href="delete_mobile.php?id=<?php echo $fld['id']?>" class="btn btn-danger">Delete</a></td>
                         </tr>
                    <?php
                         }
                    ?>
